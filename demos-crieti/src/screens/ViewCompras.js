...
const ViewCompras = ({ navigation, route }) => {
    ...
    */
    ...
    async function deleteUsers(id) {
        try {
            ...
            Alert.alert("Confirma?", `Excluir usuário ${userId}`, [
                {
                    onPress: async () => {
    ...
    return (
        ...
        <SafeAreaView style={theme.safeArea}>
            ...
            <View style={[theme.container, { backgroundColor: 'rgba(212, 148, 102, 0.653)'}]}>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <ItemUser
                            item={item}
                            deleteUser={() => deleteUsers(item.id)}
